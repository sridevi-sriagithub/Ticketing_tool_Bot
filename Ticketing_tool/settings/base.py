...
# =================== BOT FRAMEWORK ======================
MICROSOFT_APP_ID = env("MICROSOFT_APP_ID", default="")
MICROSOFT_APP_PASSWORD = env("MICROSOFT_APP_PASSWORD", default="")

BOT_SERVICE_ENDPOINT = env("BOT_SERVICE_ENDPOINT", default="")
